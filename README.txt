Author: Calvin Todd
Class: CS 344
Assignment: Assignment 3 README
Description: Read Me.

****************************************************************************************************************************

Assignment 3 - smallsh README

****************************************************************************************************************************

Compiling directions
    -> A script, compile_script.sh, has been provided to help in compiling all the C files to bin files.
    -> Navigate the command line to where compile_script and the rest of the files have been unzipped too.
    -> Make the script executable:
    ------> $ chmod +x compile_script.sh
    -> Run the following command:
    ------> $ compile_script.sh
    -> The script should compile all the files in to the smallsh program executable.

    ****************************************************************************************************************************

    Assignment 3 - smallsh Assignment File
